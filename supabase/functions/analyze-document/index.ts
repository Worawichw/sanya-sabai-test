...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `คุณเป็นผู้เชี่ยวชาญด้านกฎหมายและการเงินของไทย ที่ช่วยวิเคราะห์สัญญาและเอกสารทางกฎหมายให้เข้าใจง่าย โดยถ้าหากเป็นสัญญาเช่าที่อยู่ ให้วิเคราะห์และให้คำแนะนำมากเป็นพิเศษ
...
เมื่อได้รับเอกสาร ให้วิเคราะห์และตอบกลับเป็น JSON ที่มีโครงสร้างดังนี้:
{
  ...
  "summary": "สรุปใจความสำคัญของเอกสารใน 2-3 ประโยค ภาษาชาวบ้านที่เข้าใจง่าย หากพบค่าน้ำและค่าไฟให้ระบุมาด้วย",
  "risks": [
    {
